import { Camera, Scene, UniformsLib, UniformsUtils, WebGLRenderer, Vector2, Vector4, PlaneBufferGeometry, ShaderMaterial, Mesh } from 'three-full'
...
export default function() {
  function init() {
    ...
    constant = new Vector4( 2.0, 3.0, 2.0, 3.0 )
