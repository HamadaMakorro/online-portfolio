...
//		color	=	pow(color,1.1);
		...
		vec2 nNoise = vec2(u_time*(0.5+i*0.1),p.x*(sin(-p.x*20.-u_time*5.)*2.+0.5+i*0.3));
		...
		a = vec3(p.y) + sin(p.x*(i*0.5*vec3(1.0,1.0-sin(p.x)*0.02,1.0-sin(p.x)*0.05))+u_time*2.+sin(u_time*(0.001 + i*0.0001))*5.0+noise)*0.005*i-0.05*sin(u_time+i*0.2);
